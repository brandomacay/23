...
public class SurfaceScaleSample {
	public static void play(TextSurface textSurface) {
		...
		Text textA = TextBuilder.create("").setPosition(Align.SURFACE_CENTER).build();
		Text textB = TextBuilder.create("Te amo").setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textA).build();
		Text textC = TextBuilder.create("Solange").setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textB).build();
