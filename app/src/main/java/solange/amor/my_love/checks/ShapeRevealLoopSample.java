...
public class ShapeRevealLoopSample {
	public static void play(TextSurface textSurface) {
		...
		Text textA = TextBuilder.create("Nunca te olvides de mi").setSize(25).setPosition(Align.SURFACE_CENTER).build();
		Text textB = TextBuilder.create("hare lo mismo por ti").setSize(25).setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textA).build();
		Text textC = TextBuilder.create("Hoy,mañana").setSize(25).setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textB).build();
		Text textD = TextBuilder.create("y siempre.").setSize(25).setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textC).build();
