...
public class ShapeRevealSample {
	public static void play(TextSurface textSurface) {
		...
		Text textA = TextBuilder.create("Tratare de ser una mejor persona para ti").setPosition(Align.SURFACE_CENTER).build();
		Text textB = TextBuilder.create("cuando?").setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textA).build();
		Text textC = TextBuilder.create("justo ahora").setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textB).build();
		Text textD = TextBuilder.create("y en cada momento").setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textC).build();
