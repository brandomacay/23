...
public class DiscrollvableGreenLayout extends LinearLayout implements Discrollvable {
    ...
    protected void onFinishInflate() {
        ...
        mGreenView1 = findViewById(R.id.greenView1);
        mGreenView1TranslationY = mGreenView1.getTranslationY();
        mGreenColor = getResources().getColor(R.color.morado);
    }
    ...
    public void onDiscrollve(float ratio) {
        ...
        if(ratio >= 0.5f) {
            ...
            mGreenView1.setTextColor((Integer) mArgbEvaluator.evaluate(ratio, R.color.white, mGreenColor));
